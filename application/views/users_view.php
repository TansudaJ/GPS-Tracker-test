                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <!-- <thead>
                                ...
                                <tbody>
                                    <tr class="odd gradeX">
                                        <td>สมชาย ใจดี</td>
                                        <td>somchai_ji@tracker.ac.th</td>
                                        <td>Admin</td>
                                        <td class="center">active</td>
                                        <td class="center">

                                            <button type="button" title="Edit" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i> </button>
                                            <button type="button" title="Edit" class="btn btn-danger btn-sm"><i class="fa fa-trash-alt"></i> </button>
                                        </td>
                                    </tr>
